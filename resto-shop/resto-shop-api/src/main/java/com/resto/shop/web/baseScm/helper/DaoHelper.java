...
public class DaoHelper {
     ...
     * @param tableName       dto对应的数据库表名
     */
    public static void genXMLWithFeature(String path, Class mapperInterface, Class mapperDO, String tableName,Boolean isOverWrite) {
        genXMLWithFeature(path, mapperInterface, mapperDO, tableName, true,isOverWrite);
    }
     ...
     */
    public static void genXMLWithFeature(String path, Class mapperInterface, Class mapperDO, String tableName, Boolean isDeleteLogically,Boolean isOverWrite) {
        if (StringUtils.isBlank(path) || mapperInterface == null || mapperDO == null) {
            return;
        }
