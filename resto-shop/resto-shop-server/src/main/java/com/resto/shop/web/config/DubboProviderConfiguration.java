 ...
 */
@Configuration
@DubboComponentScan("com.resto.shop.web.service.impl") // 扫描 Dubbo 组件
public class DubboProviderConfiguration {

    @Value("zookeeper://${rpc.registry_address}")
    private String zkAddress;

    @Value("${dubbo.shop.port}")
     ...
     * 当前应用配置
     */
    @Bean(name = "provider_consumer_shop")
    public ApplicationConfig applicationConfig() {
        ApplicationConfig applicationConfig = new ApplicationConfig();
        applicationConfig.setName("provider_consumer_shop");
