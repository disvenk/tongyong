...
.menu-list-box select.form-control {
	width: 185px;
}
</style>
<div id="controlShop">
<a class="btn btn-info ajaxify" href="articleSell/newShopList">
...
<div class="row" id="searchTools">
	<div class="col-md-12">
		<!-- 用过的菜单列表 -->
		<div class="row menu-list-box form-inline">
			<div class="col-md-3 form-group">
				<label>
					选择菜单：
					<select class="form-control" v-model="menuId">
						<option value="">全部</option>
						<option :value="menu.menuId" v-for="menu in menuList">{{menu.menuName}}</option>
					</select>
				</label>
			</div>
		</div>
...
<script>
	...
	var vueObjShop = new Vue({
	    ...
	    created : function() {
			...
			// 获取门店的菜单列表
			var that = this
			$.post("articleSell/listShopMenu", null, function(result) {
				that.menuId = ''
	    ...
	    methods : {
	        ...
	        searchInfo : function() {
	        	...
	        	try{
                    ...
                    $.post("articleSell/queryShopOrderArtcileNew", this.getDate(), function(result) {
