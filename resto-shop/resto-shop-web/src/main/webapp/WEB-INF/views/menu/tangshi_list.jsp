...
<div id="control" v-cloak>
                  ...
                  <div class="caption ">
                    ...
                    <div class="table-wrap">
                      <table class="table table-wrap">
                          ...
                          <tbody>
                          <tr v-for="(index,art) in articleList" v-if="!art.checked && (art.distributionModeId==1 || art.distributionModeId==3) ">
                              <td>{{index+1}}</td>
    ...
    <!-- 编辑菜品 -->
    <edit-article v-if="showArticleEdit" :article="currArticle" :showArticleEdit="showArticleEdit" @close="closeArticleEdit"></edit-article>
    <!-- 启用门店 -->
    ...
    <div class="table-div">
        ...
        <div class="table-operator">
            <s:hasPermission name="menuTangshi/add">
                <button class="btn blue pull-right" @click="create">新建堂食菜单</button>
            </s:hasPermission>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        var menuType = 1; // 堂食1；外卖2
        var tb = $table.DataTable({
            ajax : {
                url : "menu/tangshiListAll?menuState=1",
        ...
        var vueObj = new Vue({
            ...
            created: function () {
                ...
                //$.post("articlelibrary/list_all", null, function (data) {
            ...
            methods:{
                ...
                filterByState: function(state) {
                    this.state = state;
                    tb.ajax.url('menu/tangshiListAll?menuState='+state).load();
                },
                // 新建菜单,初始化model
                create: function() {
                    this.m = {
