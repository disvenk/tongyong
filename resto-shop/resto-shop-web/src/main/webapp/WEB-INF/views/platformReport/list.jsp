        ...
        <div class="panel panel-primary" style="border-color:write;">
            ...
            <div class="panel panel-info">
                <div class="panel-heading text-center">
                    <strong style="margin-right:100px;font-size:22px">品牌外卖订单表</strong>
                </div>
                <div class="panel-body">
                    <table id="brandOrderTable" class="table table-striped table-bordered table-hover" width="100%">
                        ...
                        <tbody>
                        <template v-if="brandAppraise.count != null">
                            <tr>
                                <td><b>{{brandAppraise.brandName}}</b></td>
                    ...
                    columns : [
                        ...
                        },*/
                        {
                            ...
                            createdCell: function (td, tdData, rowData) {
                                var button = $("<a href='platformReport/shopReport?beginDate="+that.searchDate.beginDate+"&&endDate="+that.searchDate.endDate+"&&shopId="+tdData+"' class='btn green ajaxify '>查看详情</a>");
                                $(td).html(button);
                            }
                        }
                    ]
            ...
            searchInfo : function() {
                ...
                try {
                    $.post("platformReport/datas", this.getDate(null), function (result) {
                        if (result.success) {
                            that.brandAppraise = result.data.allPlatformReportDto;
