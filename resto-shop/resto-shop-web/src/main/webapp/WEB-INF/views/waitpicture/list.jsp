...
<div id="control">
		...
		<div class="col-md-offset-3 col-md-6">
			<div class="portlet light bordered">
				<div class="portlet-title">
					<div class="caption">
						<span class="caption-subject bold font-blue-hoki">等位叫号轮播图片</span>
					</div>
				</div>
				<div class="portlet-body">
					<form role="form" class="form-horizontal" action="{{m.id?'waitpicture/modify':'waitpicture/create'}}" @submit.prevent="save">
						<div class="form-body">
	...
	<div class="table-div">
		<div class="table-operator">
			<%--<s:hasPermission name="waitpicture/add">--%>
			...
			columns : [
				...
				},
				{
					...
					createdCell:function(td,tdData,rowData,row){
						var operator=[
							<s:hasPermission name="waitpicture/delete">
							C.createDelBtn(tdData,"waitpicture/delete"),
							</s:hasPermission>
							<s:hasPermission name="waitpicture/edit">
