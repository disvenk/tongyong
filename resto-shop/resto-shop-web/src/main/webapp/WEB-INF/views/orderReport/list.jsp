    ...
    <div class="row" id="searchTools">
        <div class="col-md-12">
            <form class="form-inline">
                ...
                <%--<button type="button" style="float: right;" class="btn btn-primary" @click="createOrderExcel">下载报表</button>--%>
            </form>
                    ...
                    <table id="brandOrderTable" class="table table-striped table-bordered table-hover" width="100%">
                        ...
                        <%--<template v-if="brandOrder.brandName != null">--%>
                            <tr>
                                ...
                                <td>{{brandOrder.orderPosDiscountMoney}}</td>
                                <td>{{brandOrder.memberDiscountMoney}}</td>
                                <td>{{brandOrder.realEraseMoney}}</td>
                            </tr>
                       <%-- </template>
                        <template v-else>
                            <tr>
