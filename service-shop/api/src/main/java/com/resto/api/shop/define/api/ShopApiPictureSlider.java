...
@Api(description = "图片滑动", position = 1)
@RequestMapping(value = ShopConstant.PICTURE_SlIDER, produces = MediaType.APPLICATION_JSON_VALUE)
public interface ShopApiPictureSlider {

    @ApiOperation(value = "根据门店id查询")
    @GetMapping("/selectListByShopId")
    List<PictureSliderDto> selectListByShopId(@ApiParam(value = "品牌id", required = true) @RequestParam("brandId") String brandId,
