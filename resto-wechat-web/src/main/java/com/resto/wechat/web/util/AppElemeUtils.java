 ...
 * @date 2016/3/4
 */
public class AppElemeUtils {


    private static final Logger LOG = Logger.getLogger(AppElemeUtils.class);
     ...
     * @return
     */
    public static MobilePackageBean unpack(HttpServletRequest request, HttpServletResponse response, String authorization) {
        //设置跨域访问
