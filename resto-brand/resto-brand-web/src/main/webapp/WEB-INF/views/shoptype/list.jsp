...
<div id="control">
		...
		<div class="col-md-offset-3 col-md-6">
			<div class="portlet light bordered">
				...
				<div class="portlet-body">
					<form role="form" action="{{m.id?'shoptype/modify':'shoptype/create'}}"	@submit.prevent="save">
						<div class="form-body">
	...
	<div class="table-div">
		<div class="table-operator">
			<s:hasPermission name="shoptype/add">
			...
			columns : [
						...
						},
						{
							...
							createdCell:function(td,tdData,rowData,row){
								var operator=[
									<s:hasPermission name="shoptype/delete">
									C.createDelBtn(tdData,"shoptype/delete"),
									</s:hasPermission>
									<s:hasPermission name="shoptype/edit">
