...
public class OssUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String key = uploadFile(multipartFile, BUCKETNAME);
    ...
    public static String uploadPackage(MultipartFile file, String bucketNameType) {
        try {
...
//            InputStream in = new FileInputStream(file);
    ...
    public static String uploadJinDuFile(HttpServletRequest request, MultipartFile multipartFile, String bucketNameType) {
        try {
...
//            InputStream inputStream = new FileInputStream(file);
            uploadjinduFileOSS(request,file,inputStream,name,bucketNameType);
    ...
    public static String uploadjinduFileOSS(HttpServletRequest request, File file, InputStream inputStream, String fileName, String bucketNameType) {
