 ...
 */
public class CipCaterCouponConsumptionHistoryLocalRequest extends CipCaterStringPairRequest {
    private String date;
    private Integer offset;
    private Integer limit;

    public CipCaterCouponConsumptionHistoryLocalRequest() {
        this.url = RequestDomain.preUrl.getValue() + "/tuangou/coupon/queryLocalListByDate";
