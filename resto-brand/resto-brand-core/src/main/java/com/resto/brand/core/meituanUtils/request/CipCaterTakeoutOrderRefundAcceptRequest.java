 ...
 */
public class CipCaterTakeoutOrderRefundAcceptRequest extends CipCaterStringPairRequest {
    private Long orderId;
    private String reason;

    public CipCaterTakeoutOrderRefundAcceptRequest() {
        this.url = RequestDomain.preUrl.getValue() + "/waimai/order/agreeRefund";
