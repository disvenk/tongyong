 ...
 */
public class CipCaterTakeoutOrderQueryByIdRequest extends CipCaterStringPairRequest {
    private Long orderId;

    public CipCaterTakeoutOrderQueryByIdRequest() {
        this.url = RequestDomain.preUrl.getValue() + "/waimai/order/queryById";
